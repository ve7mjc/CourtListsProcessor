	...
	try:
		...
		if (path.exists(target_filename)):
			try:
				...
				if (hash_downloaded == hash_existing):
					print("DEBUG:",target_filename,"exists in cache AND hashes match")
					exists = True
				else: 
					print("DEBUG:",target_filename,"exists in cache but hashes differ")
					# assumed exists = False

			except Exception as err:
				print("ERROR: unable to open", target_filename)
		...
		if not exists:
			try:
				...
				print("ERROR: unable to write", target_filename)
